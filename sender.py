...
class HandleControllerCommand:
    ...
    def convertHandleControllerParameterToCanBusParameter(self):
        # マイナスの値は送れないので、+ 1しておく
        self.canbus_steering = int((self.steering+1) * 100)
        ...
        self.message_Steering_Command.setDataFromInt(1, 240, self.canbus_steering)
        ...
        self.message_Throttle_Command.setDataFromInt(1, 1, self.canbus_brake_pedal, 100)
